...
public class NewBeeMallGoodsDetailVO implements Serializable {
    ...
    private List<String> goodsLargeImg;
    ...
    public List<String> getGoodsLargeImg() {
        return goodsLargeImg;
    }

    public void setGoodsLargeImg(List<String> goodsLargeImg) {
        this.goodsLargeImg = goodsLargeImg;
    }
